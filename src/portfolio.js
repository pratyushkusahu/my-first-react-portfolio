...
const greeting = {
  ...
  subTitle:
    "A passionate individual who always thrives to work on end to end products which develop sustainable and scalable social and technical systems to create impact.",
  resumeLink:
    "https://drive.google.com/file/d/1b9uu2xPzLhkZyVeo1vxLBuCrWuLsLZUn/view?usp=drive_link",
  portfolio_repository: "https://github.com/pratyushkusahu",
  ...
  data: [
    {
      ...
      skills: [
        "⚡ A Java developer specializing in ETL software development, Spring FrameWorks,JavaScript, SQL, and computer science. A strong background in supporting the design and development of user-centric web applications. Adept at performing complex testing to refine application performance and functionality.",
    ...
    },
    {
      ...
      skills: [
        "⚡ Developing web applications using React-JS, JSP, HTML,CSS,JQueries",
        "⚡ Building responsive mobile front end using Android Studios-Java",
        "⚡ Creating application backend in JAVA, Spring & SQL",
      ],
      softwareSkills: [
        {
          skillName: "HTML5",
  ...
  degrees: [
    {
      ...
      duration: "2018 - 2020",
      descriptions: [
        "⚡ I Have Graduated with a score of 8.4 CGPA",
        "⚡ I have taken varity of courses such as Advance JAVA ,DSA, Cloud Computting, Big Data Analysis,Theory Of computation,etc.",
        "⚡ Apart from this, I have participated in inter-department Sports like badminton,carrom,etc.",
      ],
    ...
    },
    {
      ...
      duration: "2015 - 2018",
      descriptions: [
        "⚡ I Have Graduated with a score of 8.5 CGPA",
        "⚡ I have studied basic software engineering subjects like C,JAVA,Data Structure & Algorithms, DBMS, OS, Computer Networking, OOAD etc.",
        "⚡ I have received award as Best Student of 2018 of CUTM,Balangir",
      ],
      website_link: "https://cutm.ac.in/",
    },
  ],
      ...
      experiences: [
        {
          ...
          company: "Tejosma Technologies",
          company_url: "https://tejosma.com/",
          logo_path: "Tejosma-Technologies-Logo.png",
      ...
      experiences: [
        {
          ...
          company: " at Accurate Info-Solutions",
          company_url:
